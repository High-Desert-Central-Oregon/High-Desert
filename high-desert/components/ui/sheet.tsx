...
/**
 * Sheet — a slide-in panel built on Radix Dialog, so it comes with a focus trap,
 * Esc-to-close, focus return, and the correct aria wiring for free. Styled with
 * the app's semantic tokens (current theme). Used for the mobile nav drawer.
 */
...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-6 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
