...
| **Terms of Membership + Privacy** (formal `/legal/terms`, consent-gate v0.1, and the formal Privacy Policy) | Published legal terms; enforceable | Draft v2 now reflects signed IEF sponsorship, Gregory Chism as member-data/subscription operator, Supabase + Resend, and message deletion. Remaining: counsel review of contracting name, age, venue/liability, NCII/CSAM process; name the payment provider before paid membership; fluent Spanish review. |
...
| **IEF Fiscal Sponsorship Agreement** *(executed copy not in repo)* | Defines sponsored responsibilities and fund routing | **Signed, confirmed 2026-08-29.** Preserve the executed copy in the appropriate private records; Weimer recusal/related-party controls remain. Member subscriptions and member data are handled by Gregory Chism; either Gregory or IEF may be the named party to a contract. |
