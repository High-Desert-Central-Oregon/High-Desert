// /legal/privacy — the formal privacy policy, rendered from a single markdown
// source of truth (content/legal/privacy.md) with react-markdown + remark-gfm.
// Static Server Component: reads the file with fs at build, no client JS. The
// plain-language summary at /privacy links here.
//
// Draft handling:
...
//  - The page is noindex until the policy is finalized (see metadata.robots).
...
export const metadata: Metadata = {
  ...
  // TODO: remove noindex when policy is final (counsel sign-off + placeholders filled)
  robots: { index: false },
};
...
export default function LegalPrivacyPage() {
  ...
  if (placeholders.length > 0) {
    console.warn(
      `\n[legal/privacy] ${placeholders.length} unfilled placeholder(s) in content/legal/privacy.md — fill before publishing:\n  ${placeholders.join("\n  ")}\n`,
    );
  }
