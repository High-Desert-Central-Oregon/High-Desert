<!-- Governance Charter & Bylaws (Working Draft v0.1 — NOT YET ADOPTED)
     Rendered from the authoritative Word source: docs/Steppe-Governance-Charter-v0.1-DRAFT.docx
...
privacy-protective operating policy. Verification evidence is held only
as long as needed and is exempt from the no-images principle that
otherwise applies to community content.
...
of operating expenses. Moderators serve staggered, one-year renewable
