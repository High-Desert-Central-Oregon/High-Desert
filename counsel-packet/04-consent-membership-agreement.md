# Consent / Membership Agreement (documents table, v0.1) — rendered at /welcome read-and-confirm gate

Source: seed/documents-terms-privacy-v0.1.sql  ·  DRAFT pending legal review  ·  (retained-set enumeration aligned to include the date, 2026-07-08)

=====================  TERMS OF MEMBERSHIP  (documents.kind = 'terms')  =====================
